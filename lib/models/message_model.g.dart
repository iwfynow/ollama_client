...
void _messageModelAttach(
  ...
  object.id = id;
  object.chat.attach(col, col.isar.collection<ChatModel>(), r'chat', id);
}
...
extension MessageModelQueryLinks
    on QueryBuilder<MessageModel, MessageModel, QFilterCondition> {
  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition> chat(
      FilterQuery<ChatModel> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'chat');
    });
  }

  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition> chatIsNull() {
    return QueryBuilder.apply(this, (query) {
