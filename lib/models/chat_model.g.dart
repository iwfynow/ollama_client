...
ChatModel _chatModelDeserialize(
  ...
  final object = ChatModel(id: id, name: reader.readString(offsets[0]));
  object.id = id;
  object.name = reader.readString(offsets[0]);
  object.chats = IsarLinks<MessageModel>();
  return object;
}
...
void _chatModelAttach(IsarCollection<dynamic> col, Id id, ChatModel object) {
  object.id = id;
  object.chats
      .attach(col, col.isar.collection<MessageModel>(), r'messages', id);
}
...
extension ChatModelQueryLinks
    on QueryBuilder<ChatModel, ChatModel, QFilterCondition> {
  QueryBuilder<ChatModel, ChatModel, QAfterFilterCondition> messages(
  ...
  QueryBuilder<ChatModel, ChatModel, QAfterFilterCondition> messagesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
